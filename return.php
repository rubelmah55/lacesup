                ...
                <div class="row">
                    <div class="col-12">
                        <div class="block-contents me-lg-5 pe-lg-5">
                            <?php 
                                $privacy = get_field('return_policy');
                                ...
                                if(!empty($privacy['button'])){
                                    printf('<p class="mt-4"><a href="%s" class="link" target="%s">%s</a></p>', $privacy['button']['url'], $privacy['button']['target'], $privacy['button']['title']);
                                }
                             ?>
